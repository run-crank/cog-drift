...
### Authentication
<!-- run `crank cog:readme stackmoxie/drift` to update -->
...
5. Run `crank cog:install --source=local --local-start-command="npm start"` to
   ...
   flag or run `crank cog:uninstall stackmoxie/drift` if you've already
...
[what-is-crank]: https://crank.run?utm_medium=readme&utm_source=stackmoxie%2Fdrift
